...
import { Search, User, Phone, X, ChevronRight } from 'lucide-react';
...
export function SearchSuggestions({
  ...
  const [fetchSuggestions, { data }] = useLazyQuery(query, {
    fetchPolicy: 'network-only',
    onCompleted: () => setHasSearched(true),
  });

  const suggestions: SearchSuggestion[] = data?.memberSearchSuggestions || [];
